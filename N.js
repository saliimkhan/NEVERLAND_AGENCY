...
function text1(){
    var clutter ="";
    document.querySelector("#page-1 h1").textContent.split(" ").forEach(function(char){
...
function text2(){
    var clutter ="";
    document.querySelector("#page-1 h4").textContent.split(" ").forEach(function(char){
        clutter += `<span> ${char}</span>`
    })
    
    document.querySelector("#page-1 h4").innerHTML = clutter;
    
    gsap.to("#page-1 h4 span",{
        scrollTrigger:{
            trigger:`#page-1 h4 span`,
            scroller:`#main`,
            // markers:true,
            start: `100% top`,
            end:`1000% top`,
...
function text3(){
  var clutter ="";
  document.querySelector("#page-2 h3").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-2 h3").innerHTML = clutter;

  
  gsap.from("#page-2 h3 span",{
      scrollTrigger:{
          trigger:`#page-2 h3 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 100%`,
          end:`top 20%`,
...
function text4(){
  var clutter ="";
  document.querySelector("#page-2 h2").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-2 h2").innerHTML = clutter;

  
  gsap.from("#page-2 h2 span",{
      scrollTrigger:{
          trigger:`#page-2 h2 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 30%`,
          end:`top -10%`,
...
function text5(){
  var clutter ="";
  document.querySelector("#page-3 h5").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-3 h5").innerHTML = clutter;

  
  gsap.from("#page-3 h5 span",{
      scrollTrigger:{
          trigger:`#page-3 h5 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 99%`,
          end:`top 60%`,
...
function text7(){
  var clutter ="";
  document.querySelector("#page-3 h1").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-3 h1").innerHTML = clutter;

  
  gsap.from("#page-3 h1 span",{
      scrollTrigger:{
          trigger:`#page-3 h1 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 70%`,
          end:`top -20%`,
...
function text6(){
  var clutter ="";
  document.querySelector("#page-3 #h2").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-3 #h2").innerHTML = clutter;

  
  gsap.from("#page-3 #h2 span",{
      scrollTrigger:{
          trigger:`#page-3 #h2 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 33%`,
          end:`top 20%`,
...
function text8(){
  var clutter ="";
  document.querySelector("#page-7 h1").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-7 h1").innerHTML = clutter;

  
  gsap.to("#page-7 h1 span",{
      scrollTrigger:{
          trigger:`#page-7 h1 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 83%`,
          end:`top 30%`,
...
function text9(){
  var clutter ="";
  document.querySelector("#page-7 #h3").textContent.split(" ").forEach(function(char){
      clutter += `<span> ${char}</span>`
  })
  
  document.querySelector("#page-7 #h3").innerHTML = clutter;

  
  gsap.to("#page-7 #h3 span",{
      scrollTrigger:{
          trigger:`#page-7 #h3 span`,
          scroller:`#main`,
          // markers:true,
          start: `top 25%`,
          end:`top 5%`,
...
function text12(){
  var clutter = "";
    document.querySelector("#page-8 h2").textContent.split("").forEach(function(char){
            clutter += `<span> ${char} </span>`
    })
    document.querySelector("#page-8 h2").innerHTML = clutter;
}
...
gsap.from("#page-8 h2 span",{
  scrollTrigger:{
    trigger:`#page-8 h2 span`,
    start:`7700% top`,
    end:`7900% top`,
    // markers:true,
    scrub:1,
